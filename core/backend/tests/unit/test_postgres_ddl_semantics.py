...
SOFT_REFERENCE_ALLOWLIST = {
    ...
    ("entity_refs", "entity_id"): "Typed external/domain entity identifier.",
    ("entity_refs", "scope_id"): "Optional polymorphic scope identifier.",
    ...
    ("knowledge_relations", "created_from_assessment_id"): "Reserved for a future assessment table.",
