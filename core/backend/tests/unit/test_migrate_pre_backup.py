"""Static guards for scripts/db/migrate.sh pre-migration backup safety.
...
MIGRATE_SH = REPO_ROOT / "scripts" / "db" / "migrate.sh"
RESET_SH = REPO_ROOT / "scripts" / "db" / "reset-postgres.sh"
DUMP_SH = REPO_ROOT / "scripts" / "db" / "dump.sh"
RESTORE_SH = REPO_ROOT / "scripts" / "db" / "restore.sh"
SYSTEM_BACKUP_SH = REPO_ROOT / "scripts" / "system" / "backup.sh"
SYSTEM_RESTORE_SH = REPO_ROOT / "scripts" / "system" / "restore.sh"
SYSTEM_VERIFY_SH = REPO_ROOT / "scripts" / "system" / "verify-restore.sh"
