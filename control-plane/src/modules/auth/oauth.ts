...
export interface GoogleOAuthClient {
  exchangeCode(config: ControlPlaneConfig, code: string): Promise<GoogleTokens>;
...
export function googleConfigured(config: ControlPlaneConfig): boolean {
...
export function buildGoogleAuthUrl(config: ControlPlaneConfig, state: string): string {
...
export function loginErrorUrl(config: ControlPlaneConfig, reason: string): string {
