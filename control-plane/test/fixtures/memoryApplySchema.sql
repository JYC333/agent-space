-- Schema fixture for control-plane memory APPLY integration tests
-- (testcontainers, Stage 6 slice 7b). SOURCE OF TRUTH: backend alembic
-- migrations / models.py MemoryEntry + ProvenanceLink + MemoryRelation + Space.
