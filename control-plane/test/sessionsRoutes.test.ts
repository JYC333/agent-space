...
describe("session summary internal route", () => {
  it("serves latest active session summary from the TS sessions authority", async () => {
...
describe("session read routes", () => {
  it("serves the session list from the TS read model with space/user scope", async () => {
