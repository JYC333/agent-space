-- control-plane/migrations/0001_baseline.sql
-- GENERATED, then FROZEN — do not edit by hand.
-- Source: pg_dump --schema-only of the backend Alembic head
--   (revision f1a06c8a5d75, backend/migrations/versions/0001_canonical_initial_schema.py).
-- The schema is frozen during the re-platform; future changes are added as new
-- NNNN_*.sql files in this directory, not by editing this baseline. Python/Alembic
-- remains the schema authority until the final cutover; if the backend schema
-- must change before then, regenerate this dump from a fresh Alembic head.
