...
export const researchSearchStrategies = pgTable("research_search_strategies", {
  ...
  foreignKey({ columns: [table.operationId], foreignColumns: [projectOperations.id], name: "research_search_strategies_operation_delete_fkey" }).onDelete("set null"),
  foreignKey({ columns: [table.operationId, table.spaceId], foreignColumns: [projectOperations.id, projectOperations.spaceId], name: "research_search_strategies_operation_fkey" }),
