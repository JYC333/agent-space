...
export type IntakeRetentionPolicy = Exclude<SourceRetentionPolicy, "archived">;
...
export function retentionForCapturePolicy(capturePolicy: SourceCapturePolicy): IntakeRetentionPolicy {
...
export function capturePolicyScanState(capturePolicy: string): {
  ...
  retention: IntakeRetentionPolicy;
