...
export const ARXIV_NEW_PAPERS_PROFILE_GUIDANCE = [
  ...
  "- Prefer research signal over feed mechanics; skip generic intake bookkeeping unless it affects follow-up.",
];

export function arxivPostProcessingItemMetadataLines(item: IntakeItemRow): string[] {
