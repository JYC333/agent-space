...
-- Superset of intakeCustomSourceHandlersSchema.sql /
-- intakeCustomSourceMaterializerSchema.sql plus source_connectors and
-- extraction_jobs, since CustomSourceCreateFlowService exercises
-- PgIntakeRepository.createConnection (connector lookup) and the scan-job
