"""Python public memory routes fail closed under fixed TS authority.

The TS control plane owns memory read routes plus public memory proposal
creation. Python returns 410 for moved routes so the fallback proxy cannot keep
a second authority alive.
"""
...
def test_memory_read_routes_fail_closed_under_ts_authority(api_client, db, cross_space_pair):
