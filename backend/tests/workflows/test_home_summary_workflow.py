...
def test_home_summary_tracks_activity_proposals_runs_and_excludes_other_space(
    ...
    empty_a = cross_space_pair["client_a"].get("/api/v1/home/summary", params=_params(a, ua.id)).json()
    empty_b = cross_space_pair["client_b"].get("/api/v1/home/summary", params=_params(b, ub.id)).json()
    ...
    filled_a = cross_space_pair["client_a"].get("/api/v1/home/summary", params=_params(a, ua.id)).json()
    ...
    still_b = cross_space_pair["client_b"].get("/api/v1/home/summary", params=_params(b, ub.id)).json()
...
def test_home_summary_suggests_runtime_when_space_has_no_enabled_adapter(
    ...
    b = cross_space_pair["space_b_id"]
    ub = cross_space_pair["user_b"]
    data = cross_space_pair["client_b"].get("/api/v1/home/summary", params=_params(b, ub.id)).json()
