...
_reg(
    ...
    PolicyActionDefinition(
        ...
        current_enforcement_point=(
            "app.proposals.ProposalService.create_proposal"
            ", app.proposals.ProposalService.create_user_proposal"
    ...
    PolicyActionDefinition(
        ...
        default_required_approver_role="owner",
        current_enforcement_point="app.proposals.ProposalService.accept via proposal.apply",
        description=(
    ...
    # origin runs is denied or approval-gated unless an active same-space
    # AutomationCredentialGrant pre-authorizes the firing automation.
