...
from ..runtimes.credentials import (
    ...
    resolve_effective_model_provider_id,
...
from .runtime_bridge import RunEventRuntimeSink, RunProcessRegistryAdapter
        ...
        try:
            ...
            with execution_workspace(
                ...
                ctx = RuntimeExecutionContext(
                    ...
                    model_provider_id=effective_model_provider_id,
                    ...
                    event_sink=RunEventRuntimeSink(
                        self.db, run_id=run_id, space_id=run_space_id
                    ),
