...
_REGISTRY: list[Module] = [
    ...
    Module("agents",        "Agents",          "app.agents",        always_on=True, proposal_appliers="proposal_appliers"),
    ...
    Module("runtime_adapters",  "Runtime Adapters",      "app.runtime_adapters",  always_on=True),
