...
Canonical location: ``backend/app/runtimes/``
...
from .ports import RuntimeEventSink, RuntimeProcessRegistry
...
class RuntimeExecutionContext:
    ...
    # these — never by importing app.runs. None means no emission/registration.
