...
from ..memory import CodePatchApplyError, memory_entry_to_out
from ..policy import ProposalRiskLevelError
from ..participation.service import try_record_participation
from .list_params import resolve_proposal_list_status
from .service import ProposalAcceptResult, ProposalService
...
from ..knowledge.read_model import knowledge_item_to_out, knowledge_item_relation_to_out
    ...
    *,
    ...
    if result.knowledge_relation is not None:
        return ProposalAcceptOut(
            ...
            result={"knowledge_relation": knowledge_item_relation_to_out(result.knowledge_relation).model_dump(mode="json")},
        )
