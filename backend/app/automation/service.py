"""AutomationService — create, update, and fire automations.
...
This service must NOT:
  ...
  - Own the periodic scheduler loop or external event triggers.
  - Grant credentials directly; scheduled pre-authorization is limited to
    AutomationCredentialGrant lifecycle rows.
"""
