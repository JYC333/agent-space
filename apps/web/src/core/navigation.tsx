...
export const RAIL_ITEMS: RailItem[] = [
  ...
  { id: 'space-settings', label: 'Space Settings', to: '/space-settings', icon: Building2, scope: 'space', footer: true, requiresSpaceAdmin: true, activePaths: ['/network-profiles', '/plugins', '/retrieval-settings'] },
